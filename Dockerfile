...
RUN <<EOF
apt-get update
apt-get install -y curl build-essential python3 git cmake pkg-config
EOF
...
libdir=${WASI_SDK_SYSROOT}/lib/wasm32-wasi \
...
addlib ${WASI_SDK_SYSROOT}/lib/wasm32-wasi/libz.a
save
end
AR
EOF
