...
class TreeNodes
{
    ...
    {
        return new ColumnDefinition(location, identifier(location, name), type, Optional.empty(), true, emptyList(), Optional.empty());
    }

    public static ColumnDefinition columnDefinition(NodeLocation location, String name, DataType type, boolean nullable)
    {
        return new ColumnDefinition(location, identifier(location, name), type, Optional.empty(), nullable, emptyList(), Optional.empty());
    }
    ...
    {
        return new ColumnDefinition(location, identifier(location, name), type, Optional.empty(), nullable, emptyList(), Optional.of(comment));
    }
    ...
    {
        return new ColumnDefinition(location, identifier(location, name), type, Optional.empty(), nullable, properties, Optional.empty());
    }
