        ...
        extends RoutineCharacteristic
{
    ...
    public PropertiesCharacteristic(List<Property> properties)
    {
    ...
    {
        this(Optional.of(location), properties);
    }

    private PropertiesCharacteristic(Optional<NodeLocation> location, List<Property> properties)
    {
        super(location);
